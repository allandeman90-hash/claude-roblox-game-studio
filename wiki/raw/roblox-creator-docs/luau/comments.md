...
title: Comments
type: raw-source
source_url: https://create.roblox.com/docs/luau/comments
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-2
category: luau-language
tags: [luau, comments, directives, strict, native, todo]
---
...
> **Info:** Roblox Studio has a similarly-named comments feature that is unrelated to code comments in Luau.
...
You can add and remove single-line comments in the Script Editor with the keyboard shortcut <kbd>Ctrl</kbd><kbd>/</kbd> (<kbd>Cmd</kbd><kbd>/</kbd>).
...
Original URL: https://create.roblox.com/docs/luau/comments
GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/luau/comments.md
Captured: 2026-04-16
