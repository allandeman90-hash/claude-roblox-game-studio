...
title: Scope
type: raw-source
source_url: https://create.roblox.com/docs/luau/scope
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-2
category: luau-language
tags: [luau, scope, local, global, capture, shadow, upvalue]
---
...
Scripts cannot access global and local variables or functions in other scripts. If you want to share values and functions between scripts, use `ModuleScripts`.
...
Original URL: https://create.roblox.com/docs/luau/scope
GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/luau/scope.md
Captured: 2026-04-16
