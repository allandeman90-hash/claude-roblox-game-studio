...
title: Metatables
type: raw-source
source_url: https://create.roblox.com/docs/luau/metatables
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-2
category: luau-language
tags: [luau, metatables, metamethods, oop, __index, __newindex, setmetatable]
---
...
When playing with metatables, you may run into some problems. If you need to use the `__index` metamethod to create new values in a table, but that table's metatable also has a `__newindex` metamethod, you'll want to use the Luau built-in function `rawset()` to set the value without invoking any metamethods. Take the following code as an example of what happens if you don't use these functions.
...
Original URL: https://create.roblox.com/docs/luau/metatables
GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/luau/metatables.md
Captured: 2026-04-16
