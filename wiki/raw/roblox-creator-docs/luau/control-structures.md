...
type: raw-source
source_url: https://create.roblox.com/docs/luau/control-structures
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-2
category: luau-language
tags: [luau, control-structures, if, while, repeat, for, break, continue, loops]
---
...
> **Alert (Error):** Always include a delay such as `task.wait()` in an infinite loop. Omitting it freezes the experience and crashes Studio.
...
Original URL: https://create.roblox.com/docs/luau/control-structures
GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/luau/control-structures.md
Captured: 2026-04-16
