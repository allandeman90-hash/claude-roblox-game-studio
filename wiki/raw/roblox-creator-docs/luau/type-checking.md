...
title: Type Checking
type: raw-source
source_url: https://create.roblox.com/docs/luau/type-checking
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-2
category: luau-language
tags: [luau, types, type-checking, generics, type-annotations, strict, nonstrict]
---

# Type Checking

> **Info:** For the latest and most complete type checking documentation, see [luau.org/typecheck](https://luau.org/typecheck).
...
To set a default mode for all scripts that you can override as needed, see `Workspace.LuauTypeCheckMode`.
...
To make it so a type can be used outside of a `ModuleScript`, use the `export` keyword:
...
Original URL: https://create.roblox.com/docs/luau/type-checking
GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/luau/type-checking.md
Captured: 2026-04-16
