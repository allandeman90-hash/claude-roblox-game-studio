...
title: UIGridLayout
type: raw-source
source_url: https://create.roblox.com/docs/reference/engine/classes/UIGridLayout
source_type: official-roblox-docs
source_repo: https://github.com/Roblox/creator-docs
source_yaml: https://github.com/Roblox/creator-docs/blob/main/content/en-us/reference/engine/classes/UIGridLayout.yaml
captured_at: 2026-04-16
captured_by: research-agent-p2-classes
category: gui-layout
tags: [roblox-class, gui, layout, grid]
---
...
- Property `UIGridLayout.AbsoluteCellCount` security: `read=None, write=None`
- Property `UIGridLayout.AbsoluteCellSize` security: `read=None, write=None`
- Property `UIGridLayout.CellPadding` security: `read=None, write=None`
- Property `UIGridLayout.CellSize` security: `read=None, write=None`
- Property `UIGridLayout.FillDirectionMaxCells` security: `read=None, write=None`
- Property `UIGridLayout.StartCorner` security: `read=None, write=None`
...
- Official docs page: https://create.roblox.com/docs/reference/engine/classes/UIGridLayout
- Authoritative YAML: https://github.com/Roblox/creator-docs/blob/main/content/en-us/reference/engine/classes/UIGridLayout.yaml
- Captured: 2026-04-16
