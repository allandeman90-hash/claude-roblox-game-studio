...
title: HttpService
type: raw-source
source_url: https://create.roblox.com/docs/reference/engine/classes/HttpService
source_type: official-roblox-docs
source_repo: https://github.com/Roblox/creator-docs
source_yaml: https://github.com/Roblox/creator-docs/blob/main/content/en-us/reference/engine/classes/HttpService.yaml
captured_at: 2026-04-16
captured_by: research-agent-1
category: networking
tags: [roblox-class, http, service, web]
---
...
[Experience Settings](../../../studio/experience-settings.md) interface in
...
- `requestOptions` : `Dictionary` — A dictionary containing information to be requested from the server. It is identical to `requestOptions` in `Class.HttpService:RequestAsync()`.
...
- `wrapInCurlyBraces` : `boolean` (default `True`) — Whether the returned string should be wrapped in curly braces (`{}`).
...
- security=`None` ; thread-safety=`Unsafe` ; tags=`Yields` ; capabilities=`Network`
...
- `nocache` : `boolean` (default `False`) — Whether the request stores (caches) the response.
...
- security=`None` ; thread-safety=`Safe` ; capabilities=`Network`
...
This method transforms a Luau [table](../../../luau/tables.md) into a JSON
...
This method also accepts `Library.buffer|buffers` up to 50 MiB, which it
...
- `content_type` : `HttpContentType` (default `ApplicationJson`) — Modifies the value in the `Content-Type` header sent with the request.
- `compress` : `boolean` (default `False`) — Determines whether the data is compressed (**gzipped**) when sent.
- `headers` : `Variant` — Used to specify some HTTP request headers.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Integer</td>
            <td>no</td>
            <td>An optional timeout value in seconds to make requests time out more quickly. Values must be greater than zero and no greater than the default request timeout. This can be useful when debugging hanging requests.</td>
        </tr>
    </tbody>
</table>
...
[Open Cloud requests](../../../cloud-services/http-service.md#use-with-open-cloud).
...
- Property `HttpService.HttpEnabled` security: `read=None, write=LocalUserSecurity`
- Method `HttpService:GetAsync` yields (tag `Yields`).
- Method `HttpService:PostAsync` yields (tag `Yields`).
- Method `HttpService:RequestAsync` yields (tag `Yields`).

## Examples

Code samples referenced in the source YAML (stored as separate files in the Roblox creator-docs repo):

- `Astronauts-in-Space` — https://github.com/Roblox/creator-docs/tree/main/content/en-us/reference/engine/classes/HttpService
- `International-Space-Station` — https://github.com/Roblox/creator-docs/tree/main/content/en-us/reference/engine/classes/HttpService
- `HttpService-Pastebin` — https://github.com/Roblox/creator-docs/tree/main/content/en-us/reference/engine/classes/HttpService
- `OpenCloud-via-HttpService` — https://github.com/Roblox/creator-docs/tree/main/content/en-us/reference/engine/classes/HttpService
- HttpService:CreateWebStreamClient: HttpService-CreateSSEWebStreamClient
- HttpService:CreateWebStreamClient: HttpService-CreateRawStreamWebStreamClient
- HttpService:GenerateGUID: HttpService-GenerateGUID
- HttpService:GetAsync: Astronauts-in-Space
- HttpService:GetAsync: International-Space-Station
- HttpService:JSONDecode: HttpService-JSONDecode
- HttpService:JSONEncode: HttpService-JSONEncode
- HttpService:PostAsync: HttpService-Pastebin
- HttpService:RequestAsync: sending-an-http-request
- HttpService:RequestAsync: OpenCloud-via-HttpService
- HttpService:UrlEncode: HttpService-UrlEncode
- HttpService:UrlEncode: HttpService-Pastebin

Full code samples were not embedded in this capture; see the source repo for the verbatim Luau code.

## Source

- Official docs page: https://create.roblox.com/docs/reference/engine/classes/HttpService
- Authoritative YAML: https://github.com/Roblox/creator-docs/blob/main/content/en-us/reference/engine/classes/HttpService.yaml
- Captured: 2026-04-16
