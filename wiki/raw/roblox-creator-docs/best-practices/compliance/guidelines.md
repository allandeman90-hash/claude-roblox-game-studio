...
type: raw-source
source_url: https://create.roblox.com/docs/chat/guidelines
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/chat/guidelines.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: compliance
tags: [compliance, chat, safety, filter]
---
...
- Original documentation: https://create.roblox.com/docs/chat/guidelines
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/chat/guidelines.md
- Captured: 2026-04-16
