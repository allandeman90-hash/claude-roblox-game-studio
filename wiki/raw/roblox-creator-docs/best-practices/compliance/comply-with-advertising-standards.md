...
type: raw-source
source_url: https://create.roblox.com/docs/production/promotion/comply-with-advertising-standards
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/production/promotion/comply-with-advertising-standards.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: compliance
tags: [compliance, advertising, policy]
---
...
- Original documentation: https://create.roblox.com/docs/production/promotion/comply-with-advertising-standards
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/production/promotion/comply-with-advertising-standards.md
- Captured: 2026-04-16
