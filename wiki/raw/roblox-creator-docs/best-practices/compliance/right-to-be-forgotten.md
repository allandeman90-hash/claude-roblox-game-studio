...
type: raw-source
source_url: https://create.roblox.com/docs/cloud-services/data-stores/right-to-be-forgotten
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud-services/data-stores/right-to-be-forgotten.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: compliance
tags: [compliance, gdpr, privacy, right-to-be-forgotten]
---

# Data store right to be forgotten (RTBF)
...
- Original documentation: https://create.roblox.com/docs/cloud-services/data-stores/right-to-be-forgotten
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud-services/data-stores/right-to-be-forgotten.md
- Captured: 2026-04-16
