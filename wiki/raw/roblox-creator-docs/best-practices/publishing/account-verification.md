...
type: raw-source
source_url: https://create.roblox.com/docs/production/publishing/account-verification
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/production/publishing/account-verification.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: publishing
tags: [publishing, verification, creator]
---
...
- Original documentation: https://create.roblox.com/docs/production/publishing/account-verification
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/production/publishing/account-verification.md
- Captured: 2026-04-16
