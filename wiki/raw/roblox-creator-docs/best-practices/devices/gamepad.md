...
title: Gamepad input
type: raw-source
source_url: https://create.roblox.com/docs/input/gamepad
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/input/gamepad.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: devices
tags: [devices, gamepad, console]
---
...
- Original documentation: https://create.roblox.com/docs/input/gamepad
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/input/gamepad.md
- Captured: 2026-04-16
