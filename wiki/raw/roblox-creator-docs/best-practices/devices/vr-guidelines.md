...
title: VR guidelines
type: raw-source
source_url: https://create.roblox.com/docs/production/publishing/vr-guidelines
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/production/publishing/vr-guidelines.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: devices
tags: [devices, vr, virtual-reality]
---
...
- Original documentation: https://create.roblox.com/docs/production/publishing/vr-guidelines
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/production/publishing/vr-guidelines.md
- Captured: 2026-04-16
