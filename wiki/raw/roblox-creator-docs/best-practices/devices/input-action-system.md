...
type: raw-source
source_url: https://create.roblox.com/docs/input/input-action-system
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/input/input-action-system.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: devices
tags: [devices, input, actions, bindings]
---
...
- Original documentation: https://create.roblox.com/docs/input/input-action-system
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/input/input-action-system.md
- Captured: 2026-04-16
