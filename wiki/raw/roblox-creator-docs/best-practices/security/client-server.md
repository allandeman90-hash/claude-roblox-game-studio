...
type: raw-source
source_url: https://create.roblox.com/docs/projects/client-server
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/projects/client-server.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: security
tags: [client-server, filtering-enabled, scripts, local-scripts]
---
...
- Original documentation: https://create.roblox.com/docs/projects/client-server
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/projects/client-server.md
- Captured: 2026-04-16
