...
type: raw-source
source_url: https://create.roblox.com/docs/scripting/security/client-server-boundary
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/scripting/security/client-server-boundary.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: security
tags: [security, client-server-boundary, remote-events, filtering-enabled]
---
...
- Original documentation: https://create.roblox.com/docs/scripting/security/client-server-boundary
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/scripting/security/client-server-boundary.md
- Captured: 2026-04-16
