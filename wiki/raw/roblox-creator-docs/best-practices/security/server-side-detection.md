...
type: raw-source
source_url: https://create.roblox.com/docs/scripting/security/server-side-detection
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/scripting/security/server-side-detection.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: security
tags: [security, detection, anti-cheat, server-side]
---

# Server-side detection and consequencing
...
- Original documentation: https://create.roblox.com/docs/scripting/security/server-side-detection
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/scripting/security/server-side-detection.md
- Captured: 2026-04-16
