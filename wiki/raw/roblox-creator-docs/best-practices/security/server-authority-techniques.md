...
type: raw-source
source_url: https://create.roblox.com/docs/projects/server-authority/techniques
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/projects/server-authority/techniques.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: security
tags: [security, server-authority, techniques, validation]
---
...
- Original documentation: https://create.roblox.com/docs/projects/server-authority/techniques
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/projects/server-authority/techniques.md
- Captured: 2026-04-16
