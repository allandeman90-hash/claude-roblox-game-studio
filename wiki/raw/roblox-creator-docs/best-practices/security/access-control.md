...
type: raw-source
source_url: https://create.roblox.com/docs/scripting/security/access-control
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/scripting/security/access-control.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: security
tags: [security, access-control, confidentiality, server-side]
---
...
- Original documentation: https://create.roblox.com/docs/scripting/security/access-control
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/scripting/security/access-control.md
- Captured: 2026-04-16
