...
type: raw-source
source_url: https://create.roblox.com/docs/scripting/security/third-party-vulnerabilities
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/scripting/security/third-party-vulnerabilities.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: security
tags: [security, third-party, supply-chain, vulnerabilities]
---
...
- Original documentation: https://create.roblox.com/docs/scripting/security/third-party-vulnerabilities
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/scripting/security/third-party-vulnerabilities.md
- Captured: 2026-04-16
