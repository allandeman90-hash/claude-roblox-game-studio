...
type: raw-source
source_url: https://create.roblox.com/docs/production/monetization/virtual-items
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/production/monetization/virtual-items.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: monetization
tags: [monetization, virtual-items, avatars]
---

# Virtual item policies
...
- Original documentation: https://create.roblox.com/docs/production/monetization/virtual-items
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/production/monetization/virtual-items.md
- Captured: 2026-04-16
