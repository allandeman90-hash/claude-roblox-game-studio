...
type: raw-source
source_url: https://create.roblox.com/docs/cloud-services/memory-stores/per-partition-limits
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud-services/memory-stores/per-partition-limits.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: open-cloud
tags: [memorystore, partition-limits]
---
...
- Original documentation: https://create.roblox.com/docs/cloud-services/memory-stores/per-partition-limits
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud-services/memory-stores/per-partition-limits.md
- Captured: 2026-04-16
