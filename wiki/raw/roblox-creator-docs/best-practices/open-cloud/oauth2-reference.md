...
type: raw-source
source_url: https://create.roblox.com/docs/cloud/auth/oauth2-reference
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud/auth/oauth2-reference.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: open-cloud
tags: [open-cloud, oauth2, reference]
---
...
- Original documentation: https://create.roblox.com/docs/cloud/auth/oauth2-reference
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud/auth/oauth2-reference.md
- Captured: 2026-04-16
