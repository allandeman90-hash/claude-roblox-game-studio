...
type: raw-source
source_url: https://create.roblox.com/docs/cloud-services/memory-stores/queue
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud-services/memory-stores/queue.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: open-cloud
tags: [memorystore, queue, matchmaking]
---
...
- Original documentation: https://create.roblox.com/docs/cloud-services/memory-stores/queue
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud-services/memory-stores/queue.md
- Captured: 2026-04-16
