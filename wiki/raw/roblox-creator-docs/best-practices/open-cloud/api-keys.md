...
type: raw-source
source_url: https://create.roblox.com/docs/cloud/auth/api-keys
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud/auth/api-keys.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: open-cloud
tags: [open-cloud, api-keys, authentication, security]
---
...
- Original documentation: https://create.roblox.com/docs/cloud/auth/api-keys
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud/auth/api-keys.md
- Captured: 2026-04-16
