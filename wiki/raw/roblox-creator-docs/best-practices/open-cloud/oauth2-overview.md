...
type: raw-source
source_url: https://create.roblox.com/docs/cloud/auth/oauth2-overview
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud/auth/oauth2-overview.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: open-cloud
tags: [open-cloud, oauth2, authentication]
---
...
- Original documentation: https://create.roblox.com/docs/cloud/auth/oauth2-overview
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud/auth/oauth2-overview.md
- Captured: 2026-04-16
