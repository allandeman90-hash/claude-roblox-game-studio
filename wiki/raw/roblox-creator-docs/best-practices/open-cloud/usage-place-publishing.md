...
type: raw-source
source_url: https://create.roblox.com/docs/cloud/guides/usage-place-publishing
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud/guides/usage-place-publishing.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: open-cloud
tags: [open-cloud, publishing, places]
---

# Usage guide for place publishing
...
- Original documentation: https://create.roblox.com/docs/cloud/guides/usage-place-publishing
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/cloud/guides/usage-place-publishing.md
- Captured: 2026-04-16
