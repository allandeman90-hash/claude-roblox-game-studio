...
title: Tag reference
type: raw-source
source_url: https://create.roblox.com/docs/performance-optimization/microprofiler/tag-table
github_source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/performance-optimization/microprofiler/tag-table.md
source_type: official-roblox-docs
captured_at: 2026-04-16
captured_by: research-agent-4
category: best-practice
subcategory: performance
tags: [performance, microprofiler, tag-reference]
---
...
- Original documentation: https://create.roblox.com/docs/performance-optimization/microprofiler/tag-table
- GitHub source: https://github.com/Roblox/creator-docs/blob/main/content/en-us/performance-optimization/microprofiler/tag-table.md
- Captured: 2026-04-16
